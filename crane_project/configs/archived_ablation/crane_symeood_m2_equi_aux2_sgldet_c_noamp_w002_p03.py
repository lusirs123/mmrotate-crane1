# crane_project/configs/crane_symeood_m2_equi_aux2_sgldet_c_noamp_w002_p03.py
#
# aux2_sgldet 最小消融 C:
#   在 B 的基础上进一步降低退化视图触发概率。
#
# 目的:
#   判断负迁移是否来自退化样本覆盖过密/分布过猛。
#
# 改动:
#   degraded_aux2_amp_loss_weight: 0.03 -> 0.0
#   aux2 loss_cls.loss_weight:     0.008 -> 0.002
#   degraded_prob:                 0.6 -> 0.3
#
# 守门:
...
work_dir = 'work_dirs/crane_symeood_m2_equi_aux2_sgldet_c_noamp_w002_p03'
