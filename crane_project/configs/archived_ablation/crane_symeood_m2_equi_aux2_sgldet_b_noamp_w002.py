# crane_project/configs/crane_symeood_m2_equi_aux2_sgldet_b_noamp_w002.py
#
# aux2_sgldet 最小消融 B:
#   关闭 aux2 幅度一致性, 并把 aux2 dense cls 权重降到 1/4。
#
# 目的:
#   判断负迁移是否主要来自 dense ATSS cls-only 对共享 backbone/FPN 的梯度过强。
#
# 改动:
#   degraded_aux2_amp_loss_weight: 0.03 -> 0.0
#   aux2 loss_cls.loss_weight:     0.008 -> 0.002
...
work_dir = 'work_dirs/crane_symeood_m2_equi_aux2_sgldet_b_noamp_w002'
