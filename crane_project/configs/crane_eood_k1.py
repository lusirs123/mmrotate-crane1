# =========================================================
# EOOD(K=1) — 消融基线
# 学术定位：1主头(RotatedEoodHead) + 1辅助头(ATSS)，推理仅主头participate。
# 对照原 EOOD(K=3)：从 crane_eood.py 裁剪，删除 FCOS 辅助头。
# 与 §16 消融阶梯对齐：此为内部消融的真正起点。
# =========================================================
...
# =========================================================
# 模型：EOOD(K=1) — 主头(RotatedEoodHead) + 1 aux(RotatedATSSHead)
# =========================================================
model = dict(
    type='Eood',
    backbone=dict(
        ...
        predictors=[
            ...
            dict(
                ...
                test_cfg=dict(
                    ...
                    max_per_img=2000)),
            # ─── Predictor 1: RotatedATSSHead（辅助监督，推理期丢弃）────
            dict(
...
# =========================================================
# 数据流形（与 crane_eood / symeood 严格对齐）
# =========================================================
...
# =========================================================
# Hook 注入：epoch 信息感知（驱动 EOOD 内部 MaxIoU→Pola 切换）
# =========================================================
custom_hooks = [
...
load_from = None
resume_from = None
work_dir = 'work_dirs/crane_eood_k1'