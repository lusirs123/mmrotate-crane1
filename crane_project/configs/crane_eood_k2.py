# =========================================================
# EOOD(K=2) — 消融对照（上界）
# 学术定位：1主头(RotatedEoodHead) + 2辅助头(ATSS + FCOS)，推理仅主头。
# K=2 = 原 crane_eood.py 的predictor配置(3个并行predictor)。
# 与 §16.3 K=1 vs K=2 决策规则对齐。
# =========================================================
...
load_from = None
resume_from = None
work_dir = 'work_dirs/crane_eood_k2'