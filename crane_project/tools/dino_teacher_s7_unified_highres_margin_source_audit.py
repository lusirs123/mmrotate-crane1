#!/usr/bin/env python3
"""Locked source-only margin audit for the unified high-resolution ranker."""
...
AUDIT_NAME = 'DINO S7 Unified High-Resolution Source Margin Audit'
LOCKED_EPOCH = 3
LOCKED_MARGINS = (0.25, 0.275, 0.30)
...
def validate_args(args):
    if args.seed != 0:
        raise ValueError('Unified high-resolution audit requires --seed 0')
    if args.dinov2_model != 'dinov2_vitl14':
        raise ValueError('Unified high-resolution audit requires dinov2_vitl14')
